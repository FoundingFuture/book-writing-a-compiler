...
An import holds its module path as one name that includes the dots, and an optional local name after `as`. A module holds the text of its `//!` and `//#!` comments.
