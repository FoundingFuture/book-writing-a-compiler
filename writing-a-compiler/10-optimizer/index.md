...
A variable of a loop has several definitions, one per assignment, and keeps its copies. Chapter 27 lists SSA among the extensions, and SSA gives every value one definition, which widens this pass.
