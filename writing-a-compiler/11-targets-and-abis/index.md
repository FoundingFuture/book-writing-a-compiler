...
The target table and the mangled symbol forms of each object format are pinned. So are the widths of the target-sized C types and the matrix at the start of this chapter. The build has zero warnings, and every `ctest` test passes.
