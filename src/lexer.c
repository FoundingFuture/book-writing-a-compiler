...
/* The words chapter 2 reserves for threads. They lex as TOKEN_RESERVED,
   which no grammar rule accepts. */
static const char *const reserved[] = {
    "atomic", "chan", "dispatch", "join", "parallel", "recv",
    "select", "send", "sync", "thread", "worker", "yield",
};
